...
if( 9.0f <= media && media <= 10.0f){
    printf("A media eh %.1f e a mensao SS.\n", media);
}else if (7.0f <= media && media <= 8.9f){
    printf("A media eh %.1f e a mensao MS.\n", media);
}else if (5.0f <= media && media <= 6.9f){
    printf("A media eh %.1f e a mensao MM.\n",media);
}else if ( 3.0f <= media && media <= 4.9f){
    printf("A media eh %.1f e a mensao MI.\n", media);
}else if(0.1f <= media && media<= 2.9f ){
    printf("A media eh %.1f e a mensao II.\n", media);
}else{ 
    printf("A media eh %.1f e a mensao SR.\n");
}
